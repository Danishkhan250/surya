...
function initializeUsers() {
  if (!fs.existsSync(usersFilePath)) {
    ...
    console.log(chalk.green('✓ Admin user created: Danish / Danishkhan786'));
  }
}
...
app.listen(PORT, '0.0.0.0', () => {
  console.log(chalk.bgBlue.white.bold(` ✅ Danish Khan Ofline WhatsApp Server running on http://0.0.0.0:${PORT} `));
